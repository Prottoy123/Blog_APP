        ...
        <Container>
          <div className="flex flex-col items-start justify-center text-left">
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mb-10 leading-relaxed">
              The place where you can share stories, lessons, and thoughts worth
              reading. From tech deep-dives to thought-provoking essays, explore
              stories that matter.
            </p>
        ...
        <div className="flex flex-col md:flex-row items-start justify-between py-10">
          <div className="mb-6 md:mb-0 text-left">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-xl mb-8">
              Dive into the latest stories, share your thoughts, and keep
              exploring articles that matter.
            </p>
